...
int main(){
  ...
  Random typeGen(0,4);
  {
    ...
    team.listRobots();
    cout << endl;
    //test to check if FindBot works                                                                                                                 
    cout<<"Checking if bot with id 49871 is still in tree"<<endl;
    if(team.findBot(49871))
    cout<<"found bot with id 49871"<<endl;
    if(team.findBot(49871) == false)
     cout<<"DIDNT find bot with id 49871"<<endl;
    cout << endl;
   ...
   //test to check FindBot to see if it can find removed BOT                                                                                        
    cout<<"\nChecking if bot with id 49871 is still in tree"<<endl;
    if(team.findBot(49871))
    cout<<"found bot with id 49871"<<endl;
    if(team.findBot(49871) == false)
    cout<<"DIDNT find bot with id 49871"<<endl;
